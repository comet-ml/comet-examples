...
experiment = Experiment(
    project_name="comet-example-keras-cnn-lstm",
)
...
params = {
    "layer1_kernel_size": kernel_size,
...
# always a good idea to print summary so it gets logged to the output tab on your
# experiment
model.summary()
