...
def main():
    ...
    # Retrieve comet artifact (optional)
    # logged_artifact = experiment.get_artifact("mnist-dataset", "michaelychong", version_or_alias="1.0.0")
    # local_artifact = logged_artifact.download("mnist.npz")

    # add custom tag to experiment
    experiment.add_tag('v1')
